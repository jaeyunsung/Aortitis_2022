#deseq2_multi_level.r                        20.01.15 -> 20.02.15  
#hur.benjamin@mayo.edu
#
#run deseq2 for DEGs: v1.26.0
#considering significant confounders: statin, ACE/ARB, history of other RDs
#
#[input data] and [input meta data] can be attained by using "prepare_DESeq2.py"
#
#cmd : deseq2_multi_level.r [input data] [input meta data] [output name]
...
dds <- DESeqDataSetFromMatrix(countData = cts,
                              colData = coldata,
                              design = ~ statin + acearb + history_rd + condition)
